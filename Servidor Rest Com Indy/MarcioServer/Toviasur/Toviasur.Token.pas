...
function TTVSToken.TemAssinaturaValida(const aToken: String): Boolean;
var
  Token: TJWT;
begin
  Token := nil;
...
function TTVSToken.Executar: String;
var
  JWT: TJWT;
begin
  JWT := nil;
...
function TTVSToken.getInformacaoRequisicao(const aToken: String): TInfoRequisicaoToken;
var
  Token: TJWT;
  Signer: TJWS;
begin
