unit MarcioClient.CController.Modelo;
...
type
  TControllerModelo = class(TControllerBase)
  public
...
procedure TControllerModelo.CarregarLista(const ANomeMetodo: String;
  Tabela: TFDMemTable);
var
  Retorno: String;
  Container: TContainerModelo;
  Cont: Integer;
  BookMark: TBookmark;
begin
  BookMark := nil;
  ...
  Container := TJson.JsonToObject<TContainerModelo>(Retorno);
  ...
  try
    ...
    begin
      ...
      Tabela.FieldByName('FABRICANTE').AsInteger := Container.Linhas[Cont].Fabricante.PK;
      Tabela.FieldByName('DESCFABRICANTE').AsString:= Container.Linhas[Cont].Fabricante.Descricao;
...
function TControllerModelo.EnviarLista(const ANomeMetodo: String;
  ...
  try
    try
      ...
      begin
        ...
        begin
          Container.AddLinha(TModelo.Create(Tabela.FieldByName('CHAVEINTERNA').AsInteger,
                                                ...
                                                TFabricante.Create(Tabela.FieldByName('FABRICANTE').AsInteger, 0, 0, 0, Tabela.FieldByName('DESCFABRICANTE').AsString)));
